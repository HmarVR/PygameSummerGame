...
class PlanetManager:
    ...
    def load_planet_textures(self):
        ...
        for name, body in BODIES.items():
            img = self.app.mesh.texture.get_texture(
...
"""
    ...
    def get_uniforms(self):
        ...
        return {
            ...
            "screenResolution": {
                "value": lambda: struct.pack("ff", *(64, 480)),
                "glsl_type": "vec2",
            },
            "aspectRatio": {
    ...
    def tp_planet(self, id=None):
        if id == None:
            ...
            self.app.camera.position.x = planet["bodyPos"].x
            self.app.camera.position.y = planet["bodyPos"].y
